...
function BattlegroundTargets:EnableConfigMode()
	...
	if(not testDataLoaded) then
		...
		ENEMY_Data[1] = { name = TARGET.."_Aa-servername", classToken = "DRUID" }
		ENEMY_Data[2] = { name = TARGET.."_Bb-servername", classToken = "PRIEST" }
		ENEMY_Data[3] = { name = TARGET.."_Cc-servername", classToken = "MAGE" }
		ENEMY_Data[4] = { name = TARGET.."_Dd-servername", classToken = "HUNTER" }
		ENEMY_Data[5] = { name = TARGET.."_Ee-servername", classToken = "WARRIOR" }
		ENEMY_Data[6] = { name = TARGET.."_Ff-servername", classToken = "ROGUE" }
		ENEMY_Data[7] = { name = TARGET.."_Gg-servername", classToken = "SHAMAN" }
		ENEMY_Data[8] = { name = TARGET.."_Hh-servername", classToken = "PALADIN" }
		ENEMY_Data[9] = { name = TARGET.."_Ii-servername", classToken = "MAGE" }
		ENEMY_Data[10] = { name = TARGET.."_Jj-servername", classToken = "DEATHKNIGHT" }
		ENEMY_Data[11] = { name = TARGET.."_Kk-servername", classToken = "DRUID" }
		ENEMY_Data[12] = { name = TARGET.."_Ll-servername", classToken = "DEATHKNIGHT" }
		ENEMY_Data[13] = { name = TARGET.."_Mm-servername", classToken = "PALADIN" }
		ENEMY_Data[14] = { name = TARGET.."_Nn-servername", classToken = "MAGE" }
		ENEMY_Data[15] = { name = TARGET.."_Oo-servername", classToken = "SHAMAN" }
		ENEMY_Data[16] = { name = TARGET.."_Pp-servername", classToken = "ROGUE" }
		ENEMY_Data[17] = { name = TARGET.."_Qq-servername", classToken = "WARLOCK" }
		ENEMY_Data[18] = { name = TARGET.."_Rr-servername", classToken = "PRIEST" }
		ENEMY_Data[19] = { name = TARGET.."_Ss-servername", classToken = "WARRIOR" }
		ENEMY_Data[20] = { name = TARGET.."_Tt-servername", classToken = "DRUID" }
		ENEMY_Data[21] = { name = TARGET.."_Uu-servername", classToken = "PRIEST" }
		ENEMY_Data[22] = { name = TARGET.."_Vv-servername", classToken = "MAGE" }
		ENEMY_Data[23] = { name = TARGET.."_Ww-servername", classToken = "SHAMAN" }
		ENEMY_Data[24] = { name = TARGET.."_Xx-servername", classToken = "HUNTER" }
		ENEMY_Data[25] = { name = TARGET.."_Yy-servername", classToken = "SHAMAN" }
		ENEMY_Data[26] = { name = TARGET.."_Zz-servername", classToken = "WARLOCK" }
		ENEMY_Data[27] = { name = TARGET.."_Ab-servername", classToken = "PRIEST" }
		ENEMY_Data[28] = { name = TARGET.."_Cd-servername", classToken = "DRUID" }
		ENEMY_Data[29] = { name = TARGET.."_Ef-servername", classToken = "ROGUE" }
		ENEMY_Data[30] = { name = TARGET.."_Gh-servername", classToken = "DRUID" }
		ENEMY_Data[31] = { name = TARGET.."_Ij-servername", classToken = "HUNTER" }
		ENEMY_Data[32] = { name = TARGET.."_Kl-servername", classToken = "WARRIOR" }
		ENEMY_Data[33] = { name = TARGET.."_Mn-servername", classToken = "PALADIN" }
		ENEMY_Data[34] = { name = TARGET.."_Op-servername", classToken = "MAGE" }
		ENEMY_Data[35] = { name = TARGET.."_Qr-servername", classToken = "DEATHKNIGHT" }
		ENEMY_Data[36] = { name = TARGET.."_St-servername", classToken = "MAGE" }
		ENEMY_Data[37] = { name = TARGET.."_Uv-servername", classToken = "HUNTER" }
		ENEMY_Data[38] = { name = TARGET.."_Wx-servername", classToken = "WARLOCK" }
		ENEMY_Data[39] = { name = TARGET.."_Yz-servername", classToken = "WARLOCK" }
		ENEMY_Data[40] = { name = TARGET.."_Zz-servername", classToken = "ROGUE" }
